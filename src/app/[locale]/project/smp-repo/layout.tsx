...
export async function generateMetadata(props: LayoutProps): Promise<Metadata> {
  ...
  const metadataByLocale: Record<string, { title: string; description: string }> = {
    en: {
      title: 'SMP Repo',
      description: "Semi clone of Google Drive for file management for Suite Mobile POS application.",
    },
    es: {
      title: 'SMP - Repo',
      description: 'Semi clon de Google Drive para gestión de archivos para aplicación Suite Mobile POS.',
    },
  }
